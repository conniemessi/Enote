...
public class SlidingListActivity extends ListActivity implements SlidingActivityBase {
	...
	/* (non-Javadoc)
	 * @see android.app.Note#onCreate(android.os.Bundle)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see android.app.Note#onPostCreate(android.os.Bundle)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see android.app.Note#findViewById(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see android.app.Note#onSaveInstanceState(android.os.Bundle)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see android.app.Note#setContentView(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see android.app.Note#setContentView(android.view.View)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see android.app.Note#setContentView(android.view.View, android.view.ViewGroup.LayoutParams)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see android.app.Note#onKeyUp(int, android.view.KeyEvent)
	 */
	@Override
